...
class GaragesandLotsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val garageList = listOf(
            ...
            LocationData("5th Street Garage", R.drawable.fifth_street_garage, "$8.00", "Sheltered with a high amount of spaces available")
        )
        ...
        val lotList = listOf(
            ...
            LocationData("Beech Lot", R.drawable.beech_lot, "$6.00", "A quiet lot, less crowded"),
            LocationData("Birch Lot", R.drawable.birch_lot, "$5.50", "Near MSU sports facilities"),
            LocationData("Cherry Lot", R.drawable.cherry_lot, "$8.00", "Less crowded, with easy access to I-25"),
            LocationData("Dogwood Lot", R.drawable.dogwood_lot, "$8.00", "Popular among students for the AES building"),
            LocationData("Elm Lot", R.drawable.elm_lot, "$6.25", "A large lot with many parking spaces"),
            LocationData("Fir Lot", R.drawable.fir_lot, "$5.50", "Near the Administration building"),
            LocationData("Holly Lot", R.drawable.holly_lot, "$6.00", "Convenient lot with many spaces at the center of campus"),
            LocationData("Juniper Lot", R.drawable.juniper_lot, "$5.25", "Less traffic, quieter"),
            LocationData("Maple Lot", R.drawable.maple_lot, "$6.00", "A smaller lot near the Cherry Creek academic building"),
            LocationData("Nutmeg Lot", R.drawable.nutmeg_lot, "$6.50", "A very limited lot mostly used by faculty"),
            LocationData("Oak Lot", R.drawable.oak_lot, "$5.75", "A very limited lot mostly used by faculty"),
            LocationData("Spruce Lot", R.drawable.spruce_lot, "$8.00", "Great lot at the center of the MSU campus"),
            LocationData("Walnut Lot", R.drawable.walnut_lot, "$5.50", "A great lot with great savings")
        )
